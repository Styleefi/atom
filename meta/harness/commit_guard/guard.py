...
담당한다. #52의 표에 정리된 일곱 이슈 계열(#30 #44 #45 #47 #49 #50 #51)
중 여섯(#30 #44 #47 #49 #50 #51)은 알려진 구멍인 채 동결했고 전부
commit_backstop이 사후에 받는다 — #47(worktree 브랜치 조회 fail-open)은
test_commit_in_secondary_worktree_blocks로 그쪽에 고정돼 있다. 나머지
#45는 원인인 정규식 폴백을 삭제해 종결했다. 아래 한계 목록도 설계상 수용된
